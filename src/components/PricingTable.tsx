...
const pricing = [
  ...
  {
    category: "largeInfantry",
    army: "15–35€",
    hero: "25–50€",
    art: "80–240€",
  },
  {
    category: "smallWalker",
    army: "25–60€",
    hero: "40–100€",
    art: "120–300€",
  },
  ...
  {
    category: "largeWalker",
    army: "100–200€",
    hero: "150–300€",
    art: "300–600€",
  },
  { category: "hugeModel", army: "180+€", hero: "250+€", art: "500+€" },
];
          ...
          {pricing.map((row, idx) => (
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-0 text-xs">
                ...
                >
                  <div className="font-semibold">{t("labels.army")}</div>
                ...
                >
                  <div className="font-semibold">{t("labels.hero")}</div>
                ...
                >
                  <div className="font-semibold">{t("labels.art")}</div>
